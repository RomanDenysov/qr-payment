...
export const metadata: Metadata = {
  ...
  description:
    "Bezplatný online generátor QR kódov vo formátoch BySquare a EPC (SEPA) pre Slovensko. Vytvorte a upravte QR kód pre platbu bez registrácie — vlastné farby, logo a text. Funguje so všetkými slovenskými bankami.",
  keywords: [
    "QR kód",
    "platba",
    "BySquare",
